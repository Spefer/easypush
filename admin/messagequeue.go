...
type MessageQueue interface {
	...
	MPush(serverId int32, userIds []string, msg *proto.PushMsg) error
	Broadcast(msg *proto.PushMsg) error
	BroadcastTopic(serverId []int32, topic string, msg *proto.PushMsg) error
}
...
func InitMQ() (MessageQueue, error) {
	...
	} else if strings.Compare(conf.Type, InternalMqName) == 0 {
		mq = new(InternalMq)
	} else {
...
func (mq *MessageQueueNSQ) MPush(serverId int32, userId []string, msg *proto.PushMsg) (error) {
...
func (mq *MessageQueueNSQ) BroadcastTopic(serverId []int32, topic string, msg *proto.PushMsg) (error) {
...
func (mq *MessageQueueKafka) MPush(serverId int32, userId []string, msg *proto.PushMsg) (error) {
	v := &proto.MQMsg{OP: define.MQ_MESSAGE_MULTI, ServerId: []int32{serverId}, UserId: userId, Msg: msg}
	return mq.push(v)
}
...
func (mq *MessageQueueKafka) BroadcastTopic(serverId []int32, topic string, msg *proto.PushMsg) (error) {
	v := &proto.MQMsg{OP: define.MQ_MESSAGE_BROADCAST_TOPIC, ServerId: serverId, Topic: topic, Msg: msg}
	return mq.push(v)
}
